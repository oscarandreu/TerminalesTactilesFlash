...
function listenerInmueble(id) {
	...
	case 49 :
		if (pagInm == 1) {
			if (valVal.charAt(0) == 1) {
			inmuebleA = "Piso";
			inmuebleB = "Atico";
			gotoAndPlay("resultados", 1);
			}
		} else {
			if (valVal.charAt(6) == 1) {
			inmuebleA = "Parcela";
			inmuebleB = "";
			gotoAndPlay("resultados", 1);
			}
	...
	case 50 :
		if (pagInm == 1) {
			if (valVal.charAt(1) == 1) {
			inmuebleA = "Apartamento";
			inmuebleB = "Estudio";
			gotoAndPlay("resultados", 1);
			}
		} else {
			if (valVal.charAt(7) == 1) {
			inmuebleA = "Finca";
			inmuebleB = "";
			gotoAndPlay("resultados", 1);
			}
	...
	case 51 :
		if (pagInm == 1) {
			if (valVal.charAt(2) == 1) {
			inmuebleA = "Bungalow";
			inmuebleB = "Adosado";
			gotoAndPlay("resultados", 1);
			}
		} else {
			if (valVal.charAt(8) == 1) {
	...
	case 52 :
		if (pagInm == 1) {
			if (valVal.charAt(3) == 1) {
			inmuebleA = "Chalet";
			inmuebleB = "";
			gotoAndPlay("resultados", 1);
			}
		} else {
			if (valVal.charAt(9) == 1) {
			inmuebleA = "Oficina";
			inmuebleB = "";
			gotoAndPlay("resultados", 1);
			}
	...
	case 53 :
		if (pagInm == 1) {
			if (valVal.charAt(4) == 1) {
			inmuebleA = "Duplex";
			inmuebleB = "Triplex";
			gotoAndPlay("resultados", 1);
			}
		} else {
			if (valVal.charAt(10) == 1) {
			inmuebleA = "Garage";
			inmuebleB = "";
			gotoAndPlay("resultados", 1);
			}
